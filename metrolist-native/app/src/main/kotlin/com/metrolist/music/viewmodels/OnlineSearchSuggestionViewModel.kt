                        ...
                        if (query.isEmpty()) {
                            ...
                            if (parsedUrl != null) {
                                ...
                                combine(
                                    ...
                                    database.searchSongsExtended(query, 3),
                                    database.searchArtists(query, 2),
                                    database.searchAlbums(query, 2),
                                ) { history, localSongs, localArtists, localAlbums ->
                                    val filteredLocalSongs = if (hideVideoSongs) localSongs.filter { !it.song.isVideo } else localSongs
                                    SearchSuggestionViewState(
                                        history = history,
                                        suggestions =
                                            result
